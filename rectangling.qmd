...
# `{r} # locations |>  #   select(city, formatted_address, geometry) |>  #   unnest_wider(geometry) |>  #   select(!location:viewport) |> #   unnest_wider(bounds) |>  #   rename(ne = northeast, sw = southwest) |>  #   unnest_wider(c(ne, sw), names_sep = "_")`
